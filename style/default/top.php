...
<div style="width:850px;height:129px;background:url(images/banner.jpg)">
			<div style="width:200px;height:40px;font-size:35px;color:#fff;font-weight:900;margin:30px 0px 0px 10px;"><?php echo $config_row['website_title'];?></div>
		</div>

		<div style="width:100%;height:auto;background:#CADCEB;font-size:16px;color:#105289;text-align:left;float:left;clear:left;margin:10px 0px 0px 0px;padding:10px 0px 10px 0px;">
			<?php 
			if(isset($_SESSION['u'])){
				?>
